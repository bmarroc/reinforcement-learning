...
"""Class that defines the neural network model for the baseline function.
"""
...
class LossFunction():
    ...
    def __call__(self, y_true, y_pred):
        ...
        return tf.math.reduce_mean(tf.math.square(y_true-y_pred)) + regularization
...
class Callback():
    ...
    def on_epoch_end(self, epoch, logs=None):
        if self.verbose:
            ...
            tf.print('Epochs {}/{}'.format(epoch+1, self.model.epochs))
...
class BFunction():
    ...
    def build(self):
        ...
        self.h2 = Layer2(input_dim=2, 
                         output_dim=64)
        self.h2_ = Layer2(input_dim=64, 
                         output_dim=64)
        self.h3 = Layer3(input_dim=64, 
                         output_dim=1)
